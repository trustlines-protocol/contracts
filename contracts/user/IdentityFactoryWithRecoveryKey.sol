...
contract IdentityFactoryWithRecoveryKey {
    ...
    //cost ~2.4M gas
    function CreateProxyWithControllerAndRecoveryKey(address _adminKey, address _userKey, address _recoveryKey, uint _longTimeLock, uint _shortTimeLock, bytes _publicKeyUser) {
