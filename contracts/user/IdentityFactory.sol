...
contract IdentityFactory {
    ...
    //cost ~2.4M gas
    function CreateProxyWithControllerAndRecovery(address _adminKey, address _userKey, address[] _delegates, uint _longTimeLock, uint _shortTimeLock, bytes32 _publicKeyUser) {
